...
class SentryRepository
{
    ...
    protected static function configureSentryScopes() : void
    {
        ...
        \Sentry\configureScope([static::class, 'setSentryScopes']);
    }
     ...
     */
    public static function setSentryScopes(\Sentry\State\Scope $scope) : void
    {
        ...
        $scope->setTag('request_type', Configuration::get('mwc.mode', 'web'));
