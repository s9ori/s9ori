...
use GoDaddy\WordPress\MWC\Core\WooCommerce\Payments\Frontend\Views\PaymentForm\PaymentMethodView;
...
class PaymentForm
{
    ...
    protected $paymentMethodViews = [
        ...
        AlternativePaymentMethod::class => PaymentMethodView::class,
    ];
    ...
    protected function renderPaymentMethods()
    {
        ...
        <p class="form-row form-row-wide">
            ...
            <input
                ...
                class="mwc-payments-use-new-payment-method mwc-payments-<?php echo esc_attr($this->providerName); ?>-payment-method"
