...
class GoDaddyPayInPersonGateway extends AbstractPaymentGateway
{
    ...
    public function admin_options()
    {
        ...
        if (Poynt::hasPoyntSmartTerminalActivated()) {
            ...
            $devicesUrl = 'https://payments.godaddy.com/in-person/devices';
            $catalogsUrl = Worldpay::shouldLoad() ? $poyntHubUrl.'catalogs' : $poyntHubUrl.'in-person/catalog';
            $customizeUrl = Worldpay::shouldLoad() ? $poyntHubUrl.'settings/store/terminals' : $poyntHubUrl.'in-person/customization'; ?>
    ...
    {
        return sprintf(
            Poynt::getHubUrl().'/in-person/shop/78d12aa5-6b75-4669-b661-8501023046c9%s',
    ...
    {
        return update_option('mwp_payments_sync_catalog_options', array_merge($options, get_option('mwp_payments_sync_catalog_options', [])));
    }
