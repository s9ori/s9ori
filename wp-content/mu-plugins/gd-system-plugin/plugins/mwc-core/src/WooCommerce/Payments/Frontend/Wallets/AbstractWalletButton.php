...
abstract class AbstractWalletButton
{
    ...
    {
        return str_replace('_', '-', strtolower(Configuration::get($this->getWalletConfigurationKey('buttonStyle'), static::BUTTON_STYLE_BLACK)));
    }
    ...
    {
        return str_replace('_', '-', strtolower(Configuration::get($this->getWalletConfigurationKey('buttonType'), static::BUTTON_TYPE_BUY)));
    }
