...
class OrderAdapter extends CommonOrderAdapter
{
    ...
    public function convertToSource($order = null) : WC_Order
    {
        ...
        /*
         * We can only call the parent method after we set our own data because it calls @see WC_Order::calculate_totals(),
         * which saves the order into the database too soon, triggering order created events with incomplete data.
         */
