...
class MerchantProvisionedTransformer extends AbstractEventTransformer
{
    ...
    public function handle(EventContract $event) : void
    {
        ...
        if ($event instanceof EventBridgeEventContract) {
            ...
            $isMerchantProvisionedOnGDM = is_callable([MerchantProvisioningHandler::class, 'isMerchantProvisioned']) && MerchantProvisioningHandler::isMerchantProvisioned() ? 'yes' : 'no';
