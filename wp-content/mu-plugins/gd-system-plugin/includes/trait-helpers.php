...
trait Helpers {
    ...
    public static function get_update_php_alert_text() {
        ...
        $update_php_title_text = __('Update your version of PHP to make your site more stable, secure and up to 2X faster.');
        $update_php_description_text = __('Your current PHP version (' . PHP_VERSION . ') is no longer supported. The update is quick and reduces your risk of your site crashing.');
        $format = __('
                <div>
                    <div>
                    ' . $update_php_button . '
        ...
        if (self::is_gd()) {
            $learn_more_link = '<a
                                    href="https://godaddy.com/help/a-41164"
                                    target="_blank"
                                    rel="noopener">
                                        ' . __("Learn more") . '
                                </a>';
         ...
         */
        $contact_support_text = __('Contact support for more info.');
