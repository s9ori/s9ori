...
final class Bundled_Plugins {
	...
	public function __construct() {
		...
		$bundled_plugins = [
			...
			'wpsec/wp-captcha-plugin/init.php'  => Plugin::is_site_created_after( 1655683200 ) || Plugin::is_site_in_percentage( 80, null, 1655683200 ), // 06.20.2022 00:00:00 GMT + 80% before that date
