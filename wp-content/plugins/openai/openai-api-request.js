  ...
  if ($('#summarizeArticle').is(':checked')) {
      ...
      success: function(result) {
        ...
        messages = [
          ...
          {"role": "user", "content": "Create a numbered list of five different Tweets in " + whatTense + " without hashtags and replacing the guest's name with their Twitter handle " + author + " promoting this " + tense + " of the show: " + text1}
        ]
        var data4 = {
          "model": model,
          "messages": messages,
      ...
      messages = [
        ...
        {"role": "user", "content": "Create an original Tweet promoting this past segment of the show: Last week, the mayors office announced an increase of $14.5 million in funding for citywide cleaning operations. The Get Stuff Clean initiative includes funding to clean up No Mans Land areas, increase litter basket maintenance, and bolster rat mitigation. Meera Joshi, deputy mayor for operations, joins to talk about the plans for cleaning up the city."},
        {"role": "assistant", "content": "NYC deputy mayor for operations Meera Joshi spoke with us about the Get Stuff Clean initiative, which includes funding to clean up long-neglected areas, increase litter basket maintenance and bolster rat mitigation. https://t.co/Nhj5iRTCZF,"},
        {"role": "user", "content": "Create a numbered list of five different Tweets in " + whatTense + " without hashtags and replacing the guest's name with their Twitter handle " + author + " promoting this " + tense + " of the show: " + prompt}
        ];
      cacheCounter++; // Increment the counter
      var cachedResponse = localStorage.getItem(cacheKey);
      if (cachedResponse) {
